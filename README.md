...
* **Personalized Roadmap Generator (`backend/features/personalized_roadmap.py`):** Automatically maps identified skill gaps to sequential learning phases, resolves prerequisite order, loads lessons and practice exams, and handles external learning items (`/api/v1/career-compass/personalized-roadmap`).
