...
### CareerCompass Courses & Assessment Mock Tests (Jayasree A B)
* **Comprehensive 13-Subject Curriculum (`courses/`):** Full curriculum covering Python Fundamentals, SQL Mastery, AWS Cloud Architecture, LLMs & Generative AI, Data Structures (Arrays & Trees), Web Frameworks (Django, Flask), Data Analysis (Pandas, Excel), and Frontend Core (JavaScript, HTML, CSS).
* **Interactive Lessons & Code Demonstrations:** Granular lesson plans with step-by-step concepts, architecture explanations, syntax guides, and runnable code blocks.
* **Timed 20-Question Mock Tests:** Standardized 12-minute practice assessments with automatic grading, passing score thresholds (60%), and answer rationales (`/api/v1/courses/{id}/mock-test`).
